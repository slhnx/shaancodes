...
export const metadata = {
  ...
  slug: "optimizing-user-experience-with-usedebounce-hook-obc",
  publishDate: new Date("01/07/2023"),
  lastModified: new Date("01/07/2023"),
  author: "Shaan Alam",
  coverImage:
    "https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fufizcplzl2iiwh4zo4bf.png",
  ...
  originalUrl: "https://dev.to/shaancodes/optimizing-user-experience-with-usedebounce-hook-obc",
};
